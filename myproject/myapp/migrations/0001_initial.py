# Generated by Django 2.2 on 2019-05-22 07:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ManyToManyField(default='', through='myapp.MaterialItem', to='myapp.Material')),
                ('restaurant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.Restaurant')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='orderMaterial',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.OrderMaterial'),
        ),
        migrations.CreateModel(
