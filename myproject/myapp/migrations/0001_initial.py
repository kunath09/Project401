# Generated by Django 2.2 on 2019-05-24 10:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('materialitem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.MaterialItem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menuitem', models.ManyToManyField(null=True, to='myapp.MenuItem')),
                ('restaurant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.Restaurant')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materialitem', models.ManyToManyField(blank=True, to='myapp.MaterialItem')),
                ('restaurant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.Restaurant')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materialitem', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.MaterialItem')),
